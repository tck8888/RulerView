...
public class TapeView extends View {
    ...
    private void calculateAttr() {
        ...
        textY = calibrationLong + dp2px(30, mContext);
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        calibrationWidth = ta.getDimension(R.styleable.TapeView_calibrationWidth, dp2px(calibrationWidth, context));
        calibrationLong = ta.getDimension(R.styleable.TapeView_calibrationLong, dp2px(calibrationLong, context));
        calibrationShort = ta.getDimension(R.styleable.TapeView_calibrationShort, dp2px(calibrationShort, context));
        triangleColor = ta.getColor(R.styleable.TapeView_triangleColor, triangleColor);
        triangleHeight = ta.getDimension(R.styleable.TapeView_triangleHeight, dp2px(triangleHeight, context));
        textColor = ta.getColor(R.styleable.TapeView_textColor, textColor);
        textSize = ta.getDimension(R.styleable.TapeView_textSize, sp2px(textSize, context));
        per = ta.getFloat(R.styleable.TapeView_per, per);
        per *= 10.0f;
        perCount = ta.getInt(R.styleable.TapeView_perCount, perCount);
        gapWidth = ta.getDimension(R.styleable.TapeView_gapWidth, dp2px(gapWidth, context));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mode == MeasureSpec.AT_MOST) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec((int) dp2px(80, mContext), MeasureSpec.EXACTLY);
        }
