...
public class RulerView2  extends View {
    ...
    public RulerView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //刻度线的颜色
        lineDegreeColor = typedArray.getColor(R.styleable.RulerView2_lineDegreeColor, Color.LTGRAY);
        //顶部的直线距离View顶部距离
        topDegreeLine = typedArray.getDimension(R.styleable.RulerView2_topDegreeLine, dp2px(getContext(),45));
        //刻度间隔
        lineDegreeSpace = typedArray.getDimension(R.styleable.RulerView2_lineDegreeSpace, dp2px(getContext(),10));
        //刻度大数目 默认30
        lineCount = typedArray.getInt(R.styleable.RulerView2_lineCount, 30);
        //长的刻度线条长度
        longDegreeLine = typedArray.getDimension(R.styleable.RulerView2_longDegreeLine, dp2px(getContext(),35));
        //左间隔
        ruleLeftSpacing = typedArray.getDimension(R.styleable.RulerView2_ruleLeftSpacing, dp2px(getContext(),5));
        //右间隔
        ruleRightSpacing = typedArray.getDimension(R.styleable.RulerView2_ruleRightSpacing, dp2px(getContext(),5));
        //数字颜色
        numberColor = typedArray.getColor(R.styleable.RulerView2_numberColor, Color.BLACK);
        //数字大小
        numberSize = typedArray.getDimension(R.styleable.RulerView2_numberSize, dp2px(getContext(),15));
        //短刻度值的长度
        shortDegreeLine = typedArray.getDimension(R.styleable.RulerView2_shortDegreeLine, dp2px(getContext(),20));
        //绿色指针粗细
        greenPointWidth = typedArray.getDimension(R.styleable.RulerView2_greenPointWidth, dp2px(getContext(),4));
        //绿色指针颜色
        greenPointColor = typedArray.getColor(R.styleable.RulerView2_greenPointColor, 0xFF4FBA75);
        //当前刻度的颜色
        currentNumberColor = typedArray.getColor(R.styleable.RulerView2_currentNumberColor,
                0xFF4FBA75);
        //当前刻度的大小
        currentNumberSize = typedArray.getDimension(R.styleable.RulerView2_currentNumberSize,
                dp2px(getContext(),30));
        init(context);
        typedArray.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec){
        ...
        if (heightSpecMode == MeasureSpec.AT_MOST) {
            //这个方法确定了当前View的大小
            setMeasuredDimension(widthSpecSize, dp2px(getContext(),120));
        } else {
        ...
        //Log.d(TAG, "onMeasure: "+greenPointX);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for(int i = 0;i <= lineCount * 10;i++){
            ...
            if(i % 10 == 0){
                ...
                canvas.drawText(number, x - textWidth / 2, y + longDegreeLine + dp2px(getContext(),25), paint);
            }else {
                //画短刻度
                paint.setColor(lineDegreeColor);
                paint.setStrokeWidth(3);
        ...
        canvas.drawLine(greenPointX + getScrollX(), y, greenPointX + getScrollX(), y + longDegreeLine + dp2px(getContext(),3),
                paint);
        ...
        canvas.drawText(currentNum, greenPointX - textWidth / 2 + getScrollX(), topDegreeLine - dp2px(getContext(),15), paint);

        //画kg 大小是刻度值的3分之一
        paint.setTextSize(currentNumberSize / 3);
        canvas.drawText("kg", greenPointX + textWidth / 2 + getScrollX() + dp2px(getContext(),3), topDegreeLine - dp2px(getContext(),30), paint);
    }
